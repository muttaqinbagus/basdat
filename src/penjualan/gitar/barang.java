...
public class barang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_barang", "id_kategori", "nama_barang", "harga_barang", "stock_barang"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         ...
         try {
            String sql = "update barang set harga_barang = "
                    + jTextField4.getText() + " where id_barang = "+ jTextField1.getText();
...
private void tableload(JTable jt) {
        ...
        dt.setRowCount(0);
        try {
            ResultSet rset = db.getData("SELECT * FROM barang");
            while(rset.next()){
                Vector v = new Vector();
